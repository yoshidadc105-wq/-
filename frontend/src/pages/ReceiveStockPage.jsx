...
export default function ReceiveStockPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <h2 style={{ fontWeight: 700, fontSize: 20 }}>入荷を記録</h2>
      ...
      {!selected ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {filtered.map(p => (
              ...
              >
                ...
                <div style={{ fontSize: 13, color: '#16a34a', fontWeight: 600 }}>{p.stock}個</div>
              </div>
            ))}
          </div>
        </>
        ...
        <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div>
            <div style={{ textAlign: 'center', marginBottom: 12, fontWeight: 600, color: '#64748b' }}>入荷数</div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20 }}>
              ...
              <button
                ...
                style={{
                  width: 56, height: 56, borderRadius: '50%',
                  background: '#16a34a', color: 'white', fontSize: 28, fontWeight: 700,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}
              >＋</button>
            </div>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <button
              ...
              disabled={submitting}
              style={{ flex: 2, background: '#16a34a', color: 'white', padding: 14, borderRadius: 8, fontWeight: 700, fontSize: 16 }}
            >
